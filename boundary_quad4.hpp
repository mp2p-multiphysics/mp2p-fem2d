...
class BoundaryQuad4
{
    ...
    */
    ...
    std::vector<BoundaryConfigQuad4Struct> boundaryconfig_vec;
    ...
    BoundaryQuad4(std::string file_in_flux_str_in, std::string file_in_value_str_in)
    {
        ...
        boundaryconfig_vec = std::vector<BoundaryConfigQuad4Struct>(num_boundaryconfig);

        // initialize boundary config id vector with zero flux
        BoundaryConfigQuad4Struct boundaryconfig_zeroflux;
        ...
        BoundaryConfigQuad4Struct boundaryconfig_zerovalue;
