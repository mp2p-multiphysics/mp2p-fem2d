...
class PhysicsTransientDiffusion : public PhysicsTransientBase
{
    ...
    */
    ...
    (
        ...
        ScalarTri3 *derivativecoefficient_ptr, ScalarTri3 *diffusioncoefficient_ptr, ScalarTri3 *generationcoefficient_ptr
    );
    ...
    (
        ...
        ScalarQuad4 *derivativecoefficient_ptr, ScalarQuad4 *diffusioncoefficient_ptr, ScalarQuad4 *generationcoefficient_ptr
    );
    void matrix_fill_natural
    (
        Eigen::SparseMatrix<double> &a_mat, Eigen::SparseMatrix<double> &c_mat, Eigen::VectorXd &d_vec,
