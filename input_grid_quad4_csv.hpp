#ifndef INPUT_GRID_QUAD4_CSV
#define INPUT_GRID_QUAD4_CSV
#include <sstream>
#include <fstream>
#include <vector>
#include "grid_quad4.hpp"

GridQuad4Struct input_grid_quad4_csv(std::string file_in_point_str, std::string file_in_element_str)
{
    ...
    while (std::getline(file_in_point_stream, line_point_str))
    {
        ...
        while (std::getline(line_point_stream, value_point_str, ','))
        {
            ...
            {
                case 0: gq4s.point_id_vec.push_back(std::stoi(value_point_str)); break;
                case 1: gq4s.point_pos_x_vec.push_back(std::stod(value_point_str)); break;
                case 2: gq4s.point_pos_y_vec.push_back(std::stod(value_point_str)); break;
            }
    ...
    while (std::getline(file_in_element_stream, line_element_str))
    {
        ...
        while (std::getline(line_element_stream, value_element_str, ','))
        {
            ...
            {
                case 0: gq4s.element_id_vec.push_back(std::stoi(value_element_str)); break;
                case 1: gq4s.element_p0_id_vec.push_back(std::stod(value_element_str)); break;
                case 2: gq4s.element_p1_id_vec.push_back(std::stod(value_element_str)); break;
                case 3: gq4s.element_p2_id_vec.push_back(std::stod(value_element_str)); break;
                case 4: gq4s.element_p3_id_vec.push_back(std::stod(value_element_str)); break;
            }
